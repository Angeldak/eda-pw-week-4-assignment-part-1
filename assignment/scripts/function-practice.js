...
console.log("helloName should return the input name, Megan:", helloName("Megan"))
...
console.log("multiplyThree should multiple 3 9 and 7 to return 189", multiplyThree(3, 9, 7))
